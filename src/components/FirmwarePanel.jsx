...
function buildKeymapLayersCCode(allKeymaps, layerCount) {
  const rows = 10;
  const cols = 6;
  const layers = [];
...
export default function FirmwarePanel({ device, onBootloader, allKeymapsRef, layerCount = 4, keymapFilePath = '' }) {
